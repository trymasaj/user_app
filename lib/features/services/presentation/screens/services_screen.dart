      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            SizedBox(height: 24.h),
            // tabs
            BlocBuilder<ServiceCubit, ServcieState>(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final serviceCategory =
                          state.allServiceCategories![index];
                      final bool isSelected = serviceCategory.id ==
                          state.slectedServiceCategory!.id;
