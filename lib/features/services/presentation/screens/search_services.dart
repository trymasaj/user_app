...
class _SearchServicesScreenState extends State<SearchServicesScreen> {
  ...
  late SearchServiceCubit searchServicesCubit;

  @override
  void initState() {
    _searchController = TextEditingController();
    searchServicesCubit = Injector().searchServicesCubit;
    _searchController.addListener(() {
      if (_searchController.text.isNotEmpty) {
        searchServicesCubit.setSearchValue(_searchController.text);
      }
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider<SearchServiceCubit>.value(
      value: searchServicesCubit,
      child: Scaffold(
        body: SafeArea(
          child: BlocBuilder<SearchServiceCubit, SearchServcieState>(
...
class ServicesResults extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SearchServiceCubit, SearchServcieState>(
      builder: (context, state) {
